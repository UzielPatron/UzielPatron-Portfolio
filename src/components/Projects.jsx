    ...
    return (
        <div className="projects-container" id='projects'>
            ...
            <div className="projects-flex-container">
                ...
                <ProjectItem title='Lyriks - Music Player' description='Reproductor de música tipo Spotify con React y Tailwind CSS' img={ lyriks } url='https://lyriks-app-uzielpatron.netlify.app/' />
